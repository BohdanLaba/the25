...
import com.exmachina.the25.algorithm.AlphaStrategy;
...
public class App {
	public static void main(String[] args) {
		...
		pcPlayer1.setNickName("alpha-dummy1");
		pcPlayer1.setStrategy(new AlphaStrategy());
		game25.addPlayer(pcPlayer1);

		// game25.runGameAutomatic(100000);
		game25.runGame();
